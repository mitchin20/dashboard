...
// category routes
router.get("/categories", getCategoriesController_1.getCategoriesController);
router.put("/update-category/:id", updateCategoryController_1.updateCategoryController);
router.post("/create-category", createCategoryController_1.createCategoryController);
router.delete("/delete-category/:id", deleteCategoryController_1.deleteCategoryController);
